            ...
            <div className={classes.form}>
              ...
              <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
                <TextField
                  ...
                  helperText={errors.enrollmentId?.message}
            ...
            <div className={classes.form}>
              ...
              >
                <TextField
                  ...
                  type="text"
                  className={classes.root}
                  error={!!forgotPasswordErrors.enrollmentId}
                  helperText={forgotPasswordErrors.enrollmentId?.message}
                  {...forgotPasswordRegister("enrollmentId", {
                    required: "EnrollmentId is required",
                  })}
                />
